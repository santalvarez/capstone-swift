...
HEADERS_PATH = "/opt/homebrew/include/capstone/"
...
template = {
    ...
    'swift': {
            ...
            'out_file': './Sources/Capstone/%sEnums.swift',
            'reserved_words': [
...
def gen(lang):
    ...
    for target in include:
        ...
        lines = open(HEADERS_PATH + target).readlines()
        enums = {}
        values = {}
        doc_lines = []
...
def main():
    try:
        ...
        print(e)
        raise RuntimeError("Failed to generate Swift bindings")
